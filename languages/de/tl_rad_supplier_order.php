...
$GLOBALS['TL_LANG']['tl_rad_supplier_order']['name'] = array('Name');
$GLOBALS['TL_LANG']['tl_rad_supplier_order']['producttype'] = array('Produkte-Typ');
$GLOBALS['TL_LANG']['tl_rad_supplier_order']['tstamp'] = array('Erstellungsdatum');
$GLOBALS['TL_LANG']['tl_rad_supplier_order']['positions'] = array('Positionen');
